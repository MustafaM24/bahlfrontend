<template>
	...
	<div class="h-screen w-full bg-slate-500 flex flex-col justify-center items-center">
		<div class="text-3xl italic text-cyan-400 underline">Login</div>
		<!-- <Button></Button> -->
		<!-- <Button class=" bg-red-600 text-black h-7 w-20"><router-link to="/teller"></router-link>Click me</Button> -->
